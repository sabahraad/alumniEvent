...
class HomeController extends Controller
{
    ...
    {
        // dd('ok');
        return view('admin.registerdList');
    }
    ...
    public function pay(Request $request){
        ...
        $fields = array(
            ...
            'success_url' => 'http://localhost/foldername/cancel.php', //your success route
            'fail_url' => 'http://localhost/foldername/cancel.php', //your fail route
